...
balance += 500;
Console.WriteLine($"После пооплнения на 500: {balance}");
balance -= 200;
...
bool resultAnd = CheckAndPrint("A", false) && CheckAndPrint ("B", false);
...
Console.WriteLine("Есть ли карта постоянного клиента? (1 - да, 0 - нет):");
bool hasLoyaltyCard = int.Parse(Console.ReadLine()) == 1;
Console.WriteLine("Введите количество товаров в чеке:");
int itemsCount = int.Parse(Console.ReadLine());
bool condition1 = (purchaseAmount >= 3000) && (itemsCount >= 3);
bool condition2 = hasLoyaltyCard;
bool eligibleForDiscount = condition1 || condition2;
Console.WriteLine("Покупка >= 3000 и товаров >= 3: " + condition1);
